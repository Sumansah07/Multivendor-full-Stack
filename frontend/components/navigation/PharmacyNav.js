                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div className="relative group">
                            <span className="px-3 py-5 bg-blue-800 text-white hover:bg-blue-800 cursor-pointer flex items-center w-48 justify-center">
                                {renderLogoIcon("/pharmacy.png", "text-green-600 mx-2")}
                                Pharmacy
                                <FaChevronDown className="ml-2 text-sm transition-transform group-hover:rotate-180" />
                            </span>
                ...
                <nav className="fixed left-0 top-16 h-screen w-64 bg-teal-800 text-white p-4 overflow-y-auto">
                    ...
                    <div className="space-y-2">
                        ...
                        <div>
                            ...
                            {isProductSetupOpen && (
                                <div className="ml-4 mt-2 space-y-2">
                                    <Link href="/pharmacy/productsetup/addnew">
                                        <span className="flex items-center p-2 text-sm rounded-md hover:text-green-300">
                                            <span className="mr-2 text-blue-300">•</span>
                                            Add New
                                        </span>
                                    </Link>
                                    <Link href="/pharmacy/productsetup/list">
                                        <span className="flex items-center p-2 text-sm rounded-md hover:text-green-300">
                                            <span className="mr-2 text-blue-300">•</span>
                                            List
                                        </span>
                                    </Link>
                                    <Link href="/pharmacy/productsetup/lowstocklist">
                                        <span className="flex items-center p-2 text-sm rounded-md hover:text-green-300">
                                            <span className="mr-2 text-blue-300">•</span>
                                            Low Stock List
                                        </span>
                                    </Link>
                                    <Link href="/pharmacy/productsetup/productgallery">
                                        <span className="flex items-center p-2 text-sm rounded-md hover:text-green-300">
                                            <span className="mr-2 text-blue-300">•</span>
                                            Product Gallery
                                        </span>
                                    </Link>
                                    <Link href="/pharmacy/productsetup/newitemrequest">
                                        <span className="flex items-center p-2 text-sm rounded-md hover:text-green-300">
                                            <span className="mr-2 text-blue-300">•</span>
                                            New Item Request
                                        </span>
                                    </Link>
                                    <Link href="/pharmacy/productsetup/review">
                                        <span className="flex items-center p-2 text-sm rounded-md hover:text-green-300">
                                            <span className="mr-2 text-blue-300">•</span>
                                            Review
                                        </span>
                                    </Link>
                                    <Link href="/pharmacy/bulk-import">
                                        <span className="flex items-center p-2 text-sm rounded-md hover:text-green-300">
                                            <span className="mr-2 text-blue-300">•</span>
                                            Bulk Import
                                        </span>
                                    </Link>
                                    <Link href="/pharmacy/bulk-export">
                                        <span className="flex items-center p-2 text-sm rounded-md hover:text-green-300">
                                            <span className="mr-2 text-blue-300">•</span>
                                            Bulk Export
                                        </span>
                        ...
                        <Link href="/pharmacy/store-management/newstores">
                            <span className="flex items-center p-3 rounded-md hover:text-green-300 cursor-pointer">
                                <FaStoreAlt className="mr-3" />
                                New Stores
                            </span>
                        </Link>
                        <Link href="/pharmacy/store-management/addstores">
                            <span className="flex items-center p-3 rounded-md hover:text-green-300 cursor-pointer">
                                <FaPlusCircle className="mr-3" />
                                Add Store
                            </span>
                        </Link>
                        <Link href="/pharmacy/store-management/storeslist">
                            <span className="flex items-center p-3 rounded-md hover:text-green-300 cursor-pointer">
                                <FaStoreAlt className="mr-3" />
                                Stores List
                            </span>
                        </Link>
                        <Link href="/pharmacy/store-management/recommendedstores">
                            <span className="flex items-center p-3 rounded-md hover:text-green-300 cursor-pointer">
                                <FaPlusCircle className="mr-3" />
                                Recommended Stores
                            </span>
                        </Link>
                        <Link href="/pharmacy/bulkimport">
                            <span className="flex items-center p-3 rounded-md hover:text-green-300 cursor-pointer">
                                <FaPlusCircle className="mr-3" />
                                Bulk Import
                            </span>
                        </Link>
                        <Link href="/pharmacy/bulkexport">
                            <span className="flex items-center p-3 rounded-md hover:text-green-300 cursor-pointer">
                                <FaPlusCircle className="mr-3" />
                                Bulk Export
                            </span>
